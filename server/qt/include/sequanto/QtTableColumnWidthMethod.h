...
#ifndef SEQUANTO_QT_TABLE_COLUMN_WIDTH_METHOD_H_
#define SEQUANTO_QT_TABLE_COLUMN_WIDTH_METHOD_H_
...
namespace sequanto
{
   ...
   {
      class QtTableColumnWidthMethod : public Node
      {
      protected:
      public:
         QtTableColumnWidthMethod ();
