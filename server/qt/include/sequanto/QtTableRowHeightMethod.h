...
#ifndef SEQUANTO_QT_TABLE_ROW_HEIGHT_METHOD_H_
#define SEQUANTO_QT_TABLE_ROW_HEIGHT_METHOD_H_
...
namespace sequanto
{
   ...
   {
      class QtTableRowHeightMethod : public Node
      {
      protected:
      public:
         QtTableRowHeightMethod ();
