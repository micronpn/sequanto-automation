...
#ifdef SQ_QT_USE_CACHE
   _root->AddChild ( new QtCachedIntegerProperty( SQ_UI_NODE_X, _widget, QtCacheItem::GLOBAL_X ) );
   _root->AddChild ( new QtCachedIntegerProperty( SQ_UI_NODE_Y, _widget, QtCacheItem::GLOBAL_Y ) );
