...
const char * const SQ_UI_DEBUGGING_VERIFY_INTEGRITY SQ_CONST_VARIABLE = "verifyIntegrity";
...
const char * const SQ_UI_MOUSE_CAPTURE SQ_CONST_VARIABLE = "capture";
...
const char * const SQ_UI_ROOT_DEBUGGING SQ_CONST_VARIABLE = "debugging";
