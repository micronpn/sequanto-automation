...
#ifndef SEQUANTO_QT_LIST_LINE_HEIGHT_METHOD_H_
#define SEQUANTO_QT_LIST_LINE_HEIGHT_METHOD_H_
...
namespace sequanto
{
   ...
   {
      class QtListLineHeightMethod : public Node
      {
      protected:
      public:
         QtListLineHeightMethod ();
