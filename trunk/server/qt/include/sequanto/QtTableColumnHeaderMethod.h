...
#ifndef SEQUANTO_QT_TABLE_COLUMN_HEADER_METHOD_H_
#define SEQUANTO_QT_TABLE_COLUMN_HEADER_METHOD_H_
...
namespace sequanto
{
   ...
   {
      class QtTableColumnHeaderMethod : public Node
      {
      protected:
      public:
         QtTableColumnHeaderMethod ();
