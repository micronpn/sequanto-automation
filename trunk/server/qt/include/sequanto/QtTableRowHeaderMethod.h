...
#ifndef SEQUANTO_QT_TABLE_ROW_HEADER_METHOD_H_
#define SEQUANTO_QT_TABLE_ROW_HEADER_METHOD_H_
...
namespace sequanto
{
   ...
   {
      class QtTableRowHeaderMethod : public Node
      {
      protected:
      public:
         QtTableRowHeaderMethod ();
